...
run: clean data_point.o lin_reg.o file_operation.o temp_main.o
	$(CC) $(CFLAGS) -o run build/data_point.o build/lin_reg.o build/file_operation.o build/temp_main.o
