...
run: clean data_point.o labeled_data_point.o lin_reg.o matrix_operations.o stats_calculate.o prob_den_funcs.o file_operation.o label_list.o temp_main.o
	$(CC) $(CFLAGS) -o run build/data_point.o build/labeled_data_point.o build/lin_reg.o build/matrix_operations.o build/vector_operations.o build/helper_funcs.o build/stats_calculate.o build/prob_den_funcs.o build/file_operation.o build/label_list.o build/temp_main.o $(LIBS)
